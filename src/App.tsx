    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/cabinet/individual" element={<DashboardIndividual />} />
          <Route path="/cabinet/legal" element={<DashboardLegal />} />
          <Route path="/cabinet/management" element={<DashboardManagement />} />
